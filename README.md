...
```bash
npm add https://github.com/speakeasy-sdks-staging/nolan-onboarding-sample-sdk
```

### Yarn

```bash
yarn add https://github.com/speakeasy-sdks-staging/nolan-onboarding-sample-sdk
```
